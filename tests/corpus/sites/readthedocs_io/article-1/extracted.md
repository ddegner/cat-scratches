...
\>>> r \= requests.get('https://api.github.com/events')
\>>> r.text
'\[{"repository":{"open\_issues":0,"url":"https://github.com/...
...
\>>> payload\_tuples \= \[('key1', 'value1'), ('key1', 'value2')\]
\>>> r1 \= requests.post('https://httpbin.org/post', data\=payload\_tuples)
\>>> payload\_dict \= {'key1': \['value1', 'value2'\]}
