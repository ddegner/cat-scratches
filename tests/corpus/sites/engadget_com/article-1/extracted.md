...
Those with an advanced Google Home Premium plan will be able to access event descriptions in the timeline view. This feature, and the zoomed-in thumbnail previews, will be available for older-generation Nest cameras too.

In addition, Google has updated its familiar face detection tools. You'll be able to provide feedback on familiar face previews with a thumbs up or down to improve the feature's accuracy. The app will filter out low-quality captures (including of blurry and small faces) to clean up the face library.
