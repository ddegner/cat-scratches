...
John Doe's family filed multiple reports with Twitter, their local police department and ultimately with the US Department of Homeland Security before Twitter removed the sexually graphic material. While it was live, the illegal content racked up over 167,000 views on Twitter, and John Doe experienced "harassment, vicious bullying, and became suicidal," according to the family's [initial complaint in its 2021 lawsuit](https://www.courtlistener.com/docket/31302014/1/doe-v-twitter-inc/ "(opens in a new window)") against Twitter.

The creation and distribution of child sex abuse material, called CSAM, is one of the extreme dangers that children and teenagers face when using the internet. There's always been a spectrum of potential online harms, going back to the early days of [MySpace](https://www.cnet.com/culture/keeping-kids-safe-on-social-sites/). 

Parents have long been concerned about the lasting psychological effects of screen addiction. Many young people say social media [harms their mental health](https://www.cnet.com/news/social-media/social-media-apps-blamed-by-many-teens-for-mental-health-struggles/), fostering isolation, anxiety and [depression](https://www.cnet.com/tech/mobile/more-time-spent-on-social-media-linked-to-increase-in-teenage-depression-study-finds/). Researchers have found that teens who spend time scrolling through [curated and edited content](https://www.cnet.com/tech/services-and-software/galaxy-ais-new-photo-editing-features-social-media-inauthenticity/) can develop [unrealistic body images](https://www.cnet.com/culture/internet/instagram-and-tiktok-are-failing-users-with-eating-disorders/) and [eating disorders](https://www.cnet.com/culture/internet/instagram-and-tiktok-are-failing-users-with-eating-disorders/). Others might turn to [suicide and self-harm](https://www.cnet.com/health/personal-care/suicide-and-self-harm-content-is-scarily-easy-to-find-on-social-media/) or [become vulnerable to predators](https://www.cnet.com/culture/viral-video-shows-how-easily-predators-lure-kids-on-social-media/).
...
One mechanism for change is through the courts. On March 24, a New Mexico jury found Meta liable for [misleading users about safety and allowing child exploitation](https://www.cnet.com/tech/services-and-software/meta-loses-new-mexico-child-safety-exploitation-lawsuit-must-pay-375m/) on its platforms, ordering the company to pay $375 million to the state in penalties. The next day, a Los Angeles jury found Google and Meta liable for creating [intentionally addictive platforms to hook young users](https://www.cnet.com/tech/services-and-software/meta-google-negligent-social-media-addiction-trial-california/), ordering the two companies to pay a combined $3 million in compensatory damages. 

These landmark verdicts mark a significant shift in holding social media platforms accountable for exploiting and endangering young users. Platforms have previously avoided this because they aren't legally responsible for the content on their sites, thanks to a provision of the 1996 Communications Decency Act called Section 230. The verdicts could set a precedent for thousands of cases and lawsuits that challenge social media giants for failing to safeguard teens and children. A similar [social media addiction lawsuit](https://www.cnbc.com/2026/04/10/meta-must-face-youth-addiction-lawsuit-by-massachusetts-court-rules.html "(opens in a new window)") is now moving forward in Massachusetts.
...
The federal bill has gone through many iterations — and garnered a lot of controversy — since it was introduced in 2022 by Sens. Marsha Blackburn, a Tennessee Republican, and Richard Blumenthal, a Connecticut Democrat. The latest versions of the dual [Senate](https://www.congress.gov/bill/119th-congress/senate-bill/1748/text "(opens in a new window)") and [House of Representatives](https://www.congress.gov/bill/119th-congress/house-bill/6484/text "(opens in a new window)") bills were [reintroduced in 2025](https://www.cnet.com/news/privacy/kids-online-safety-act-goes-to-the-vote-but-could-it-mean-end-of-internet-anonymity/) and are still in committee.
...
Following the initial introduction of KOSA, the ACLU, the [Electronic Frontier Foundation](https://www.eff.org/deeplinks/2025/05/kids-online-safety-act-will-make-internet-worse-everyone "(opens in a new window)"), GLAAD and over 100 other civil society and LGBTQ+ groups [signed an open letter](https://cdt.org/insights/coalition-letter-on-privacy-and-free-expression-threats-in-kids-online-safety-act/ "(opens in a new window)") opposing the bill and expressing serious concerns around privacy and free speech.
...
Outside the US, other nations have imposed stringent legal measures. [Australia](https://www.cnet.com/tech/services-and-software/australia-social-media-ban-under-16/), [Spain](https://www.cnet.com/tech/services-and-software/spain-bans-children-from-social-media/) and [Indonesia](https://www.bloomberg.com/news/articles/2026-03-28/indonesia-starts-first-southeast-asia-social-media-ban-for-kids "(opens in a new window)") have all partially or totally banned social media for teens. But that also comes with risk. Critics pointed out that we've seen internet access and app bans weaponized by authoritarian regimes to censor critical speech. In 2020, the Egyptian government blocked news websites and [interrupted internet services](https://www.hrw.org/news/2019/09/27/egypt-hundreds-arrested-nationwide-crackdown "(opens in a new window)") amid anti-government protests. 
...
The European Commission is [building an age verification app](https://www.cnet.com/tech/services-and-software/eu-announces-age-verification-app-for-social-media/). States like California, Utah, Louisiana and Ohio have passed laws requiring platforms to verify users' ages. [Discord](https://www.cnet.com/tech/services-and-software/discord-teen-by-default-age-category/) and [Roblox](https://www.cnet.com/tech/gaming/roblox-age-based-accounts-amid-child-safety-push/) announced this year that they are rolling out age verification processes for their gaming platforms. YouTube uses [machine-learning-based AI technology](https://www.cnet.com/tech/services-and-software/youtubes-age-estimation-tech-will-spot-kids-pretending-to-be-adults-heres-how-it-works/) to identify young users, which [it says](https://blog.youtube/news-and-events/extending-our-built-in-protections-to-more-teens-on-youtube/ "(opens in a new window)") disables personalized ads, turns on digital well-being settings and adds safeguards around recommended content.
...
But age verification systems are unreliable, not least because both kids and adults have found ways to circumvent them. Tech companies [don't agree among themselves](https://www.bloomberg.com/news/articles/2025-07-25/meta-clashes-with-apple-google-over-child-age-check-legislation "(opens in a new window)") on who should be in charge of checking the age of users. Meta [has said](https://www.washingtonpost.com/technology/2023/11/15/meta-law-parental-controls-apple-google-apps/ "(opens in a new window)"), for example, that it shouldn't be app developers like them; rather, it should be done by parents when setting up their child's device, and enforced by Apple and Google's app stores.
...
Groups like the EFF [point out](https://www.eff.org/deeplinks/2025/12/10-not-so-hidden-dangers-age-verification "(opens in a new window)") that age verification systems can be harmful and discriminatory. Disproportionally, people who don't have photo IDs are [historically marginalized groups](https://www.npr.org/2024/06/11/nx-s1-4991903/voter-registration-proof-of-citizenship-requirement "(opens in a new window)"), including Black and Hispanic people and those with disabilities. Some users, such as older adults, might not be comfortable linking their ID with their account or providing a face scan, which can inadvertently kick adults out of those spaces.
...
Facial recognition tech has a [well-documented history](https://www.media.mit.edu/publications/gender-shades-intersectional-accuracy-disparities-in-commercial-gender-classification/ "(opens in a new window)") of discriminating against darker-skinned folks, women and transgender folks. Newer, AI-powered versions of these systems aren't much better. 

Even if age verification is introduced, age-specific experiences may not work as intended. Instagram, for example, has its teen accounts program, which gives teens [stronger default privacy settings](https://www.cnet.com/tech/services-and-software/instagrams-new-teen-accounts-what-parents-and-kids-need-to-know/). But researchers reviewed 47 of the teen account features, and only eight worked as advertised; two out of three safety tools were "ineffective or nonexistent," according to [a 2025 report](https://fairplayforkids.org/pf/teenaccountsbrokenpromises/ "(opens in a new window)") from Meta whistleblower Arturo Béjar and other academic and civil society groups. 
...
A now-fixed lapse let adults message teens they didn't know — a major red flag for grooming — and turn on disappearing messages, which erase proof of communication. The hidden words feature, a guardrail to flag cyberbullying, was "substantially ineffective," the report found. Meta [rebutted these claims](https://www.reuters.com/business/instagrams-teen-safety-features-are-flawed-researchers-say-2025-09-25/ "(opens in a new window)") at the time, with spokesperson Andy Stone calling them "dangerously misleading."

## The death of anonymity: Surveillance and censorship worries

Andy Yen, CEO of the Swiss privacy-forward tech company Proton, [put it bluntly](https://proton.me/blog/keep-age-verification-from-killing-anonymity-online "(opens in a new window)"): Age verification measures would be "the death of anonymity online." 

Proton has a horse in this race because it sells VPN subscriptions. People can use VPNs to bypass age gates by connecting to servers in countries where there are no restrictions. But if mass age verification procedures are rolled out, many folks may turn to a free VPN, which CNET's VPN experts say [is a security nightmare](https://www.cnet.com/tech/services-and-software/as-lawmakers-take-aim-at-vpns-the-privacy-of-millions-could-be-jeopardized/).
...
Laws and rules around content restrictions, under the guise of protecting kids, can also motivate platforms to take down more speech. If the government passes a law that makes it illegal to show kids content about smoking cigarettes, platforms might remove too much content, including posts with educational content about the dangers of smoking. 

The moderation tools social media platforms use can't reliably distinguish between informative content and content that violates their policies. And tech companies are [increasingly using AI](https://www.cnbc.com/2026/03/19/meta-cut-back-third-party-vendors-favor-of-ai-for-content-enforcement.html "(opens in a new window)") to do that moderation, making it even easier for protected speech to get swept away by error-prone tech. 
...
The lack of a coherent plan is troubling, especially because we face many of the same issues with teens and generative AI. A majority of teens (64%) use AI chatbots, [Pew Research Center](https://www.pewresearch.org/internet/2025/12/09/teens-social-media-and-ai-chatbots-2025/ "(opens in a new window)") reports. We know those tools can [hallucinate and, like social media, give us false information](https://www.cnet.com/tech/services-and-software/ai-wants-to-make-you-happy-even-if-it-has-to-bend-the-truth/). AI [safeguards don't always work](https://www.cnet.com/tech/services-and-software/ai-agents-are-getting-more-and-more-devious-study-finds/) as intended. Chatbots can be harmful for folks with mental health disorders, leading to [tragic, fatal results](https://www.cnet.com/tech/services-and-software/gemini-ai-jonathan-gavalas-wrongful-death-lawsuit-march-2026/) in rare cases. And AI can be addictive in some extreme cases, that "AI psychosis" is a kind of [chatbot echo chamber](https://www.cnet.com/tech/services-and-software/what-is-ai-psychosis-everything-you-need-to-know-about-the-risk-of-chatbot-echo-chambers/).
