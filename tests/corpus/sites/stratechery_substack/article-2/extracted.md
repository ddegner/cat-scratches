...
It’s [a must-read](http://ben-evans.com/benedictevans/2013/5/1/apple-open-and-learning-from-history); I agree with every word.
...
In the late 1970s and very early 1980s, a new breed of personal computers were appearing on the scene, including the Commodore, MITS Altair, Apple II, and more. Some employees were bringing them into the workplace, which major corporations found unacceptable[1](#fn1-289 "Sounds familiar!"), so IT departments asked IBM for something similar. After all, “No one ever got fired…”

IBM spun up a separate team in Florida to put together something they could sell IT departments. Pressed for time, the Florida team put together a minicomputer using mostly off-the shelf components; IBM’s RISC processors and the OS they had under development were technically superior, but Intel had a CISC processor for sale immediately, and a new company called Microsoft said their OS – DOS – could be ready in six months.[2](#fn2-289 "In fact, they didn’t even have an OS. They acquired the foundation and built it to order") For the sake of expediency, IBM decided to go with Intel and Microsoft.
...
1. Sounds familiar! [↩](#rf1-289 "Return to footnote 1.")
    
2. In fact, they didn’t even have an OS. They acquired the foundation and built it to order [↩](#rf2-289 "Return to footnote 2.")
