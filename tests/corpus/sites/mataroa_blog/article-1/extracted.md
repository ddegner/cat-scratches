Given mataroa’s somewhat polemic [platform methodology](https://mataroa.blog/about/methodology/) in defense of an independent web, some people have reached out to ask: Why doesn't mataroa block AI scrapers?
...
1. [robots.txt](https://www.robotstxt.org/) (check [Cloudflare's AI-related](https://developers.cloudflare.com/bots/additional-configurations/managed-robots-txt/) robots.txt docs too)
2. JavaScript proof-of-work + heuristics ([Anubis](https://xeiaso.net/blog/2025/anubis/), [go-away](https://git.gammaspectra.live/git/go-away), and [descendants](https://git.gammaspectra.live/git/go-away#other-similar-projects))
3. [Cloudflare AI Crawl Control](https://www.cloudflare.com/ai-crawl-control/)
...
The third category is by Cloudflare, a company through which ~20% of all web traffic passes through. It’s probably the most effective solution yet they too [report](https://blog.cloudflare.com/perplexity-is-using-stealth-undeclared-crawlers-to-evade-website-no-crawl-directives/) observing AI companies to attempt (and succeed) at circumventing their checks. Additionally, we are reluctant to adopt a dependency to Cloudflare, one of the companies that contribute to the centralisation of the web.
