[Edit](https://github.com/dotnet/docs/blob/main/docs/csharp/fundamentals/program-structure/index.md)

# General structure of a C# program

Tip

**New to developing software?** Start with the [Get started](../../tour-of-csharp/tutorials/) tutorials first. They walk you through writing your first C# programs before you learn about program structure.

**Experienced in another language?** You might want to skim the [Get started](../../tour-of-csharp/tutorials/) section for C#-specific syntax, then come back here.
...
File-based apps support all C# syntax and can use [preprocessor directives](../../language-reference/preprocessor-directives#file-based-apps) to configure the build system. Use file-based apps for small command-line utilities, prototypes, and experiments. A file-based app consists of a single file in a directory:
...
If your file-based app grows, you can easily convert it to a project-based app. Run [`dotnet project convert`](../../../core/tools/dotnet-project-convert) to generate a project file from your existing source file.
...
By using [top-level statements](top-level-statements), you can write executable code directly in one file without wrapping it in a class and `Main` method. This style is the default when you create a new console app with `dotnet new console`. The following example shows a modern C# program that uses [top-level statements](top-level-statements):
...
You can also define an explicit static [`Main`](main-command-line) method as the program's entry point:
...
C# is a _compiled_ language. For project-based apps, use the [`dotnet build`](../../../core/tools/dotnet-build) command to compile source files into a binary package. Use [`dotnet run`](../../../core/tools/dotnet-run) to build and run in one step. The `dotnet` CLI, included in the .NET SDK, provides many [tools](../../../core/tools/) to create, build, and manage C# projects.

For file-based apps, `dotnet run hello-world.cs` compiles and runs the single file directly - no project file required.

## Expressions and statements

If you followed the [Get started](../../tour-of-csharp/overview) tutorials, you already wrote expressions and statements. Every line of code you typed was one or the other (or both). Now let's define those terms.
...
For detailed information about statements, see [Statements](../../programming-guide/statements-expressions-operators/statements). For information about expression-bodied members, see [Expression-bodied members](../../programming-guide/statements-expressions-operators/expression-bodied-members).

* [Classes](../types/classes)
* [Structs](../../language-reference/builtin-types/struct)
* [Namespaces](namespaces)
* [Interfaces](../types/interfaces)
* [Enums](../../language-reference/builtin-types/enum)
* [Delegates](../../delegates-overview)
* [Basic concepts in the C# language specification](../../language-reference/language-specification/basic-concepts)
